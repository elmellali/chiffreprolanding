...
import { Download, Phone, Mail, MapPin, Menu, X } from 'lucide-react'
...
function AppContent() {
  ...
  return (
    <div className="min-h-screen text-slate-800 font-sans selection:bg-primary selection:text-primary-foreground">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md transition-shadow shadow-sm border-b border-slate-100">
        <div className="container mx-auto flex h-[72px] items-center justify-between px-4 lg:px-8">
          <Link to="/" onClick={closeMenu} className="flex items-center gap-2 font-bold text-2xl text-slate-900 group tracking-tight">
          ...
          {/* Desktop Nav */}
          <nav className="hidden lg:flex gap-1 text-sm font-medium ml-auto mr-6 items-center">
            <Link to="/generateur-facture-gratuit" className="px-3 py-2 rounded-lg text-primary font-bold transition-colors hover:bg-primary/10">Créer Facture</Link>
            <Link to="/#features" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary">Fonctionnalités</Link>
            <Link to="/outils/validateur-ice" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary font-semibold">Validateur ICE</Link>
            <Link to="/outils/simulateur-statut-fiscal" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary font-semibold">Simulateur Fiscal</Link>
            <Link to="/#pricing" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary">Tarifs</Link>
            <Link to="/blog" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary">Blog</Link>
            <Link to="/guides" className="px-3 py-2 rounded-lg text-slate-600 transition-colors hover:text-primary hover:bg-secondary">Guides</Link>
            <Link to="/client" className="px-3 py-2 rounded-lg text-slate-700 font-bold transition-colors hover:bg-slate-100">Espace Client</Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-slate-200 px-6 py-6 shadow-xl space-y-4">
            <nav className="flex flex-col space-y-2 font-medium text-slate-700">
              <Link to="/generateur-facture-gratuit" onClick={closeMenu} className="p-2 rounded-lg bg-primary/10 text-primary font-bold">Créer une Facture (Gratuit)</Link>
              <Link to="/#features" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Fonctionnalités</Link>
              <Link to="/outils/validateur-ice" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Validateur ICE Maroc</Link>
              <Link to="/outils/simulateur-statut-fiscal" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Simulateur Statut Fiscal</Link>
              <Link to="/#pricing" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Tarifs</Link>
              <Link to="/blog" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Blog</Link>
              <Link to="/guides" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Guides d'utilisation</Link>
              <Link to="/support" onClick={closeMenu} className="p-2 rounded-lg hover:bg-slate-100 font-semibold">Support Technique</Link>
              <Link to="/client" onClick={closeMenu} className="p-2 rounded-lg text-slate-700 font-bold">Espace Client & Activation</Link>
            </nav>
            <div className="pt-4 border-t border-slate-100 flex flex-col gap-3">
              <Button className="w-full shadow-lg font-bold" asChild>
                <a href="https://chiffrepro.com/downloads/ChiffrePro_Setup.exe">
                  <Download className="mr-2 h-4 w-4" />
                  Télécharger (Windows)
                </a>
              ...
              <a
                ...
                className="w-full py-3 bg-[#25D366] text-white font-bold text-center rounded-xl text-sm"
              >
      ...
      <footer id="contact" className="bg-slate-900 text-slate-300 py-16 border-t border-slate-800">
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12 max-w-6xl">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed font-medium mb-6">
              Le partenaire des entreprises au Maroc. Maîtrisez votre chiffre d'affaires et structurez votre croissance en toute conformité fiscale.
            </p>
          ...
          <div>
            <h4 className="font-bold text-white mb-6 uppercase tracking-wider text-sm">Produit & Outils</h4>
            <ul className="space-y-3 text-sm font-semibold">
              ...
              <li><Link to="/#features" className="hover:text-white transition-colors">Fonctionnalités ERP</Link></li>
              <li><Link to="/outils/validateur-ice" className="hover:text-white transition-colors text-primary">Validateur ICE Maroc (Gratuit)</Link></li>
              <li><Link to="/outils/simulateur-statut-fiscal" className="hover:text-white transition-colors text-primary">Simulateur Statut Fiscal 2026</Link></li>
          ...
          <div>
            <h4 className="font-bold text-white mb-6 uppercase tracking-wider text-sm">Ressources & Aide</h4>
            <ul className="space-y-3 text-sm font-semibold">
              <li><Link to="/support" className="hover:text-white transition-colors">Support technique direct</Link></li>
              <li><Link to="/guides" className="hover:text-white transition-colors">Guides d'utilisation & FAQ</Link></li>
              <li><Link to="/client" className="hover:text-white transition-colors">Espace Client & Renouvellement</Link></li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-4 mt-16 pt-8 border-t border-slate-800 text-sm text-slate-500 flex flex-col md:flex-row items-center justify-between gap-4 max-w-6xl font-semibold">
          ...
          <div className="flex gap-6">
            <span className="text-slate-500">100% Conforme Code Général des Impôts Maroc</span>
          </div>
        </div>
      </footer>
